...
public class feedbackControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Students s = (Students) session.getAttribute("student"); // Lấy đối tượng Student từ session
        int studentID = 0;
        if (s != null) {
            studentID = s.getStudentID(); // Lấy StudentID từ đối tượng Student
        }
        ...
        dao.insertFeedback(studentID, text);
