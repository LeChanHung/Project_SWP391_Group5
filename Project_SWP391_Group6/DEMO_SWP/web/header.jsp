...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fff; margin-bottom: 20px;">
            <div class="container">
                <ul class="navbar-nav">
                    <a class="navbar-brand" href="index" style="color: #000; font-size: 1.5rem; font-weight: bold;">Phòng Đào Tạo</a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index" style="color: #000; font-size: 1.5rem;">
