        ...
        <div class="table-responsive">
            <div class="table-wrapper">
				...
				<a href="edit?nid=${n.newID}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    ...
                                    <a href="#" class="delete" data-toggle="modal" onclick="showMess(${n.newID})"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                ...
                <div class="clearfix">
                    ...
                    <ul class="pagination">
                        ...
                        <li class="page-item"><a class="page-link" href="manage_news?page=${i}">${i}</a></li>
                    </c:forEach>
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="manage_news">
...
<script>
    function showMess(newID) {
        var option = confirm("sure");
        if (option == true) {
            window.location.href = 'delete?nid=' + newID;
        }
